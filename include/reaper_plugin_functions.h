...
// Note: the C++ pure virtual interfaces used require the MSVC-compatible C++
// ABI on Win32.  Sorry, mingw users.
//
// Reaper extensions: see http://www.cockos.com/reaper/sdk/plugin/plugin.php and
// reaper_plugin.h. The API functions in this header can be retrieved using
...
//   1) most source files should just #include "reaper_plugin_functions.h" as
//   is. 2) one file should #define REAPERAPI_IMPLEMENT before including this
//   file. 3) the plug-in should call REAPERAPI_LoadAPI(rec->GetFunc) from
//   REAPER_PLUGIN_ENTRYPOINT
//      and check the return value for errors (REAPERAPI_LoadAPI will return 0
//      on success).

//   By default, all functions listed in this file are loaded. This means that
//   an older version of REAPER may not succeed in loading, and also it may
//   bloat your plug-in. If you wish to only load needed functions, #define
//   REAPERAPI_MINIMAL and various #define REAPERAPI_WANT_<functionname> lines
//   before including this file. You must put these definitions where
//   REAPERAPI_IMPLEMENT is defined and you can optionally put them elsewhere
//   (to detect needed REAPERAPI_WANT_xxx lines at compile- time rather than
//   link-time).
//
...
// easiest to include reaper_plugin.h before reaper_plugin_functions.h in your
// application code. if not, you may need to edit this path.
...
REAPERAPI_DEF //==============================================
    ...
    // being sorted, so you can pass it as the last parameter, or NULL and it
    // will allocate and free space internally.
...
REAPERAPI_DEF //==============================================
              ...
              // nudgewhat: 0=position, 1=left trim, 2=left edge, 3=right edge,
    // 4=contents, 5=duplicate, 6=edit cursor nudgeunit: 0=ms, 1=seconds,
    // 2=grid, 3=256th notes, ..., 15=whole notes, 16=measures.beats (1.15 = 1
    // measure + 1.5 beats), 17=samples, 18=frames, 19=pixels, 20=item lengths,
    // 21=item selections value: amount to nudge by, or value to set to reverse:
    // in nudge mode, nudges left (otherwise ignored) copies: in nudge duplicate
    // mode, number of copies (otherwise ignored)
...
#if defined(REAPERAPI_WANT_AudioAccessorStateChanged) ||                       \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // DestroyAudioAccessor, AudioAccessorStateChanged,
...
#if defined(REAPERAPI_WANT_AudioAccessorValidateState) ||                      \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_CalculatePeaksFloatSrcPtr) ||                       \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // points are visible. Otherwise, ptidx will be based on the number of
    // visible points in the automation item, including all loop iterations. See
...
#if defined(REAPERAPI_WANT_CountSelectedMediaItems) ||                         \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // project). This function ignores the master track, see
...
#if defined(REAPERAPI_WANT_CountTempoTimeSigMarkers) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // msg, int msglen), which handles OSC messages sent from REAPER. The
    // function return is a local osc handler. See SendLocalOscMessage,
    // DestroyOscHandler.
...
REAPERAPI_DEF //==============================================
    ...
    midi_Output *(*CreateMIDIOutput)(int dev, bool streamMode,
                                     int *msoffset100);
#endif

#if defined(REAPERAPI_WANT_CreateNewMIDIItemInProj) ||                         \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // CreateNewMIDIItemInProj
    // Create a new MIDI media item, containing no MIDI events. Time is in
    // seconds unless qn is set.
...
#if defined(REAPERAPI_WANT_CreateTakeAudioAccessor) ||                         \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // CreateTakeAudioAccessor
    // Create an audio accessor object for this take. Must only call from the
    // main thread. See CreateTrackAudioAccessor, DestroyAudioAccessor,
...
#if defined(REAPERAPI_WANT_CreateTrackAudioAccessor) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_CSurf_OnInputMonitorChange) ||                      \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_CSurf_OnInputMonitorChangeEx) ||                    \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_CSurf_OnOscControlMessage) ||                       \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    double (*CSurf_OnPanChangeEx)(MediaTrack *trackid, double pan,
...
#if defined(REAPERAPI_WANT_CSurf_OnPlayRateChange) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_CSurf_OnRecArmChangeEx) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_CSurf_OnRecvVolumeChange) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_CSurf_OnSelectedChange) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_CSurf_OnSendVolumeChange) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_CSurf_OnTrackSelection) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_CSurf_OnVolumeChangeEx) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_CSurf_ResetAllCachedVolPanStates) ||                \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_CSurf_SetSurfaceRecArm) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_CSurf_SetSurfaceSelected) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_CSurf_SetSurfaceVolume) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_CSurf_SetTrackListChange) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // be based on the number of visible points in the automation item,
    // including all loop iterations. See CountEnvelopePointsEx,
    // GetEnvelopePointEx, SetEnvelopePointEx, InsertEnvelopePointEx.
...
#if defined(REAPERAPI_WANT_DeleteEnvelopePointRange) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_DeleteEnvelopePointRangeEx) ||                      \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
    ...
    bool (*DeleteEnvelopePointRangeEx)(TrackEnvelope *envelope,
                                       int autoitem_idx, double time_start,
                                       double time_end);
#endif
...
#if defined(REAPERAPI_WANT_DeleteProjectMarkerByIndex) ||                      \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // DeleteProjectMarkerByIndex
    // Differs from DeleteProjectMarker only in that markrgnidx is 0 for the
    // first marker/region, 1 for the next, etc (see EnumProjectMarkers3),
    // rather than representing the displayed marker/region ID number (see
    // SetProjectMarker4).
...
#if defined(REAPERAPI_WANT_DeleteTakeStretchMarkers) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_DestroyLocalOscHandler) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_DoActionShortcutDialog) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // DoActionShortcutDialog
    // Open the action shortcut dialog to edit or add a shortcut for the given
    // command ID. If (shortcutidx >= 0 && shortcutidx <
    // CountActionShortcuts()), that specific shortcut will be replaced,
    // otherwise a new shortcut will be added. See CountActionShortcuts,
    // GetActionShortcutDesc, DeleteActionShortcut.

    bool (*DoActionShortcutDialog)(HWND hwnd, KbdSectionInfo *section,
...
#if defined(REAPERAPI_WANT_DockWindowRefreshForHWND) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_DuplicateCustomizableMenu) ||                       \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_EditTempoTimeSigMarker) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_EnsureNotCompletelyOffscreen) ||                    \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
              // EnumPitchShiftModes
    // Start querying modes at 0, returns FALSE when no more modes possible,
    // sets strOut to NULL if a mode is currently unsupported

    bool (*EnumPitchShiftModes)(int mode, const char **strOut);
#endif

#if defined(REAPERAPI_WANT_EnumPitchShiftSubModes) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // Returns false when there is no more data. See SetProjExtState,
    // GetProjExtState.
...
#if defined(REAPERAPI_WANT_EnumRegionRenderMatrix) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // EnumRegionRenderMatrix
    // Enumerate which tracks will be rendered within this region when using the
    // region render matrix. When called with rendertrack==0, the function
...
#if defined(REAPERAPI_WANT_EnumTrackMIDIProgramNamesEx) ||                     \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // Envelope_Evaluate (often, the buffer block size). The return value is how
    // many samples beyond that time position that the returned values are
...
#if defined(REAPERAPI_WANT_Envelope_GetParentTake) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_Envelope_GetParentTrack) ||                         \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // envelope, 0 for the first automation item on the envelope, etc. See
    // SetEnvelopePoint, InsertEnvelopePoint.
...
#if defined(REAPERAPI_WANT_FindTempoTimeSigMarker) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    void (*format_timestr_len)(double tpos, char *buf, int buf_sz,
                               double offset, int modeoverride);
#endif
...
REAPERAPI_DEF //==============================================
    ...
    bool (*get_config_var_string)(const char *name, char *bufOut,
                                  int bufOut_sz);
#endif
...
#if defined(REAPERAPI_WANT_GetAllProjectPlayStates) ||                         \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
              // GetAppVersion
    // Returns app version which may include an OS/arch signifier, such as:
    // "6.17" (windows 32-bit), "6.17/x64" (windows 64-bit), "6.17/OSX64" (macOS
    // 64-bit Intel), "6.17/OSX" (macOS 32-bit), "6.17/macOS-arm64",
    // "6.17/linux-x86_64", "6.17/linux-i686", "6.17/linux-aarch64",
    // "6.17/linux-armv7l", etc
...
#if defined(REAPERAPI_WANT_GetAudioAccessorEndTime) ||                         \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_GetAudioAccessorSamples) ||                         \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // GetAudioAccessorSamples
    ...
    // audio, -1 on error. See CreateTakeAudioAccessor,
    // CreateTrackAudioAccessor, DestroyAudioAccessor,
    // AudioAccessorStateChanged, GetAudioAccessorStartTime,
    // GetAudioAccessorEndTime.//
    //
    ...
    // buf = list([0]*2*1024) # 2 channels, 1024 samples each, initialized to
    // zero pos = 0.0 (ret, buf) = GetAudioAccessorSamples(aa, 44100, 2, pos,
    // 1024, buf) # buf now holds the first 2*1024 audio samples from the track.
...
#if defined(REAPERAPI_WANT_GetAudioAccessorStartTime) ||                       \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_GetCurrentProjectInLoadSave) ||                     \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // (unlikely when want_last_valid is true)
...
#if defined(REAPERAPI_WANT_GetDisplayedMediaItemColor) ||                      \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_GetDisplayedMediaItemColor2) ||                     \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_GetEnvelopePointByTime) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_GetEnvelopePointByTimeEx) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_GetEnvelopeScalingMode) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // GetEnvelopeScalingMode
...
REAPERAPI_DEF //==============================================
    ...
    // Gets the RPPXML state of an envelope, returns true if successful. Undo
    // flag is a performance/caching hint.
...
#if defined(REAPERAPI_WANT_GetFreeDiskSpaceForRecordPath) ||                   \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_GetGlobalAutomationOverride) ||                     \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_GetIconThemePointerForDPI) ||                       \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // GetIconThemePointerForDPI
    // returns a named icontheme entry for a given DPI-scaling (256=1:1). Note:
    // the return value should not be stored, it should be queried at each
    // paint! Querying name=NULL returns the start of the structure
...
REAPERAPI_DEF //==============================================
    ...
    MediaItem *(*GetItemFromPoint)(int screen_x, int screen_y,
                                   bool allow_locked,
...
REAPERAPI_DEF //==============================================
              // GetItemStateChunk
    // Gets the RPPXML state of an item, returns true if successful. Undo flag
...
#if defined(REAPERAPI_WANT_GetLastMarkerAndCurRegion) ||                       \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
    ...
    // the displayed marker/region index, but as the index that can be passed to
    // EnumProjectMarkers. Either or both of markeridx and regionidx may be
...
#if defined(REAPERAPI_WANT_GetMasterMuteSoloFlags) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // GetMasterMuteSoloFlags
    // &1=master mute,&2=master solo. This is deprecated as you can just query
    // the master track as well.
...
REAPERAPI_DEF //==============================================
    ...
    // returns &1 if the master track is visible in the TCP, &2 if visible in
...
REAPERAPI_DEF //==============================================
    ...
    // Get text-based metadata from a media file for a given identifier. Call
    // with identifier="" to list all identifiers contained in the file,
    // separated by newlines. May return "[Binary data]" for metadata that
    // REAPER doesn't handle.
...
#if defined(REAPERAPI_WANT_GetMediaItemInfo_Value) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
    ...
    // auto-stretch timebase: C_BEATATTACHMODE=1, C_AUTOSTRETCH=1 C_AUTOSTRETCH:
    // : char * : auto-stretch at project tempo changes, 1=enabled, requires
    ...
    // pixels (read-only) I_LASTH : int * : height in track in pixels
    // (read-only) I_CUSTOMCOLOR : int * : custom color, OS dependent
    // color|0x100000 (i.e. ColorToNative(r,g,b)|0x100000). If you do not
    // |0x100000, then it will not be used, but will store the color I_CURTAKE :
    // int * : active take number IP_ITEMNUMBER : int, item number on this track
    // (read-only, returns the item number directly) F_FREEMODE_Y : float * :
    // free item positioning Y-position, 0=top of track, 1=bottom of track (will
    // never be 1) F_FREEMODE_H : float * : free item positioning height, 0=no
    // height, 1=full height of track (will never be 0) P_TRACK : MediaTrack *
    // (read-only)
    //
...
#if defined(REAPERAPI_WANT_GetMediaItemTake_Source) ||                         \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_GetMediaItemTake_Track) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_GetMediaItemTakeByGUID) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_GetMediaItemTakeInfo_Value) ||                      \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
    ...
    // high 2 bytes=shifter, low 2 bytes=parameter I_CUSTOMCOLOR : int * :
    // custom color, OS dependent color|0x100000 (i.e.
    ...
    // (read-only, returns the take number directly) P_TRACK : pointer to
    // MediaTrack (read-only) P_ITEM : pointer to MediaItem (read-only) P_SOURCE
    // : PCM_source *. Note that if setting this, you should first retrieve the
    // old source, set the new, THEN delete the old.
    //
...
#if defined(REAPERAPI_WANT_GetMediaSourceFileName) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_GetMediaSourceNumChannels) ||                       \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // used to retrieve the parent properties of sections or reversed sources
    // for example.

    PCM_source *(*GetMediaSourceParent)(PCM_source *src);
#endif

#if defined(REAPERAPI_WANT_GetMediaSourceSampleRate) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    void (*GetMediaSourceType)(PCM_source *source, char *typebuf,
                               int typebuf_sz);
#endif

#if defined(REAPERAPI_WANT_GetMediaTrackInfo_Value) ||                         \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
    ...
    // audio-thread playback state, read-only) IP_TRACKNUMBER : int : track
    // number 1-based, 0=not found, -1=master track (read-only, returns the int
    // directly) I_SOLO : int * : soloed, 0=not soloed, 1=soloed, 2=soloed in
    // place, 5=safe soloed, 6=safe soloed in place I_FXEN : int * : fx enabled,
    // 0=bypassed, !0=fx active I_RECARM : int * : record armed, 0=not record
    // armed, 1=record armed I_RECINPUT : int * : record input, <0=no input. if
    // 4096 set, input is MIDI and low 5 bits represent channel (0=all,
    // 1-16=only chan), next 6 bits represent physical input (63=all, 62=VKB).
    // If 4096 is not set, low 10 bits (0..1023) are input start channel
    // (ReaRoute/Loopback start at 512). If 2048 is set, input is multichannel
    // input (using track channel count), or if 1024 is set, input is stereo
    // input, otherwise input is mono. I_RECMODE : int * : record mode, 0=input,
    // 1=stereo out, 2=none, 3=stereo out w/latency compensation, 4=midi output,
    // 5=mono out, 6=mono out w/ latency compensation, 7=midi overdub, 8=midi
    // replace I_RECMON : int * : record monitoring, 0=off, 1=normal, 2=not when
    // playing (tape style) I_RECMONITEMS : int * : monitor items while
    // recording, 0=off, 1=on I_AUTOMODE : int * : track automation mode,
    // 0=trim/off, 1=read, 2=touch, 3=write, 4=latch I_NCHAN : int * : number of
    // track channels, 2-64, even numbers only I_SELECTED : int * : track
    // selected, 0=unselected, 1=selected I_WNDH : int * : current TCP window
    // height in pixels including envelopes (read-only) I_TCPH : int * : current
    // TCP window height in pixels not including envelopes (read-only) I_TCPY :
    // int * : current TCP window Y-position in pixels relative to top of
    // arrange view (read-only) I_MCPX : int * : current MCP X-position in
    // pixels relative to mixer container I_MCPY : int * : current MCP
    // Y-position in pixels relative to mixer container I_MCPW : int * : current
    // MCP width in pixels I_MCPH : int * : current MCP height in pixels
    ...
    // the last in the innermost and next-innermost folders, etc I_FOLDERCOMPACT
    // : int * : folder compacted state (only valid on folders), 0=normal,
    // 1=small, 2=tiny children I_MIDIHWOUT : int * : track midi hardware output
    // index, <0=disabled, low 5 bits are which channels (0=all, 1-16), next 5
    // bits are output device index (0-31) I_PERFFLAGS : int * : track
    // performance flags, &1=no media buffering, &2=no anticipative FX
    // I_CUSTOMCOLOR : int * : custom color, OS dependent color|0x100000 (i.e.
    // ColorToNative(r,g,b)|0x100000). If you do not |0x100000, then it will not
    // be used, but will store the color I_HEIGHTOVERRIDE : int * : custom
    // height override for TCP window, 0 for none, otherwise size in pixels
    // B_HEIGHTLOCK : bool * : track height lock (must set I_HEIGHTOVERRIDE
    // before locking) D_VOL : double * : trim volume of track, 0=-inf,
    // 0.5=-6dB, 1=+0dB, 2=+6dB, etc D_PAN : double * : trim pan of track, -1..1
    // D_WIDTH : double * : width of track, -1..1
    // D_DUALPANL : double * : dualpan position 1, -1..1, only if I_PANMODE==6
    // D_DUALPANR : double * : dualpan position 2, -1..1, only if I_PANMODE==6
    // I_PANMODE : int * : pan mode, 0=classic 3.x, 3=new balance, 5=stereo pan,
    // 6=dual pan D_PANLAW : double * : pan law of track, <0=project default,
    // 1=+0dB, etc P_ENV:<envchunkname : TrackEnvelope*, read only. Call with
    // :<VOLENV, :<PANENV, etc appended. B_SHOWINMIXER : bool * : track control
    // panel visible in mixer (do not use on master track) B_SHOWINTCP : bool *
    // : track control panel visible in arrange view (do not use on master
    // track) B_MAINSEND : bool * : track sends audio to parent C_MAINSEND_OFFS
    // : char * : channel offset of track send to parent B_FREEMODE : bool * :
    // track free item positioning enabled (call UpdateTimeline() after
    // changing) C_BEATATTACHMODE : char * : track timebase, -1=project default,
    // 0=time, 1=beats (position, length, rate), 2=beats (position only)
    // F_MCP_FXSEND_SCALE : float * : scale of fx+send area in MCP (0=minimum
    // allowed, 1=maximum allowed) F_MCP_FXPARM_SCALE : float * : scale of fx
    // parameter area in MCP (0=minimum allowed, 1=maximum allowed)
    // F_MCP_SENDRGN_SCALE : float * : scale of send area as proportion of the
    // fx+send total area (0=minimum allowed, 1=maximum allowed)
    // F_TCP_FXPARM_SCALE : float * : scale of TCP parameter area when TCP FX
    // are embedded (0=min allowed, default, 1=max allowed) I_PLAY_OFFSET_FLAG :
    // int * : track playback offset state, &1=bypassed, &2=offset value is
    // measured in samples (otherwise measured in seconds) D_PLAY_OFFSET :
    // double * : track playback offset, units depend on I_PLAY_OFFSET_FLAG
...
REAPERAPI_DEF //==============================================
    ...
    // command ID number for a built-in mouse modifier or built-in REAPER
    // command ID, or the custom action ID string. See SetMouseModifier for more
    // information.
    //

    void (*GetMouseModifier)(const char *context, int modifier_flag,
                             char *action, int action_sz);
#endif
...
REAPERAPI_DEF //==============================================
              // GetPeakFileName
              // get the peak file name for a given file (can be either
              // filename.reapeaks,or a hashed filename in another path)
...
REAPERAPI_DEF //==============================================
    ...
    void *(*GetPeaksBitmap)(PCM_source_peaktransfer_t *pks, double maxamp,
                            int w, int h, LICE_IBitmap *bmp);
#endif
...
#if defined(REAPERAPI_WANT_GetPreferredDiskReadMode) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // GetPreferredDiskReadMode
    // Gets user configured preferred disk read mode. mode/nb/bs are all
    // parameters that should be passed to WDL_FileRead, see for more
    // information.

    void (*GetPreferredDiskReadMode)(int *mode, int *nb, int *bs);
#endif

#if defined(REAPERAPI_WANT_GetPreferredDiskReadModePeak) ||                    \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // GetPreferredDiskReadModePeak
    // Gets user configured preferred disk read mode for use when building
    // peaks. mode/nb/bs are all parameters that should be passed to
    // WDL_FileRead, see for more information.

    void (*GetPreferredDiskReadModePeak)(int *mode, int *nb, int *bs);
#endif

#if defined(REAPERAPI_WANT_GetPreferredDiskWriteMode) ||                       \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // GetPreferredDiskWriteMode
    // Gets user configured preferred disk write mode. nb will receive two
    // values, the initial and maximum write buffer counts. mode/nb/bs are all
    // parameters that should be passed to WDL_FileWrite, see for more
    // information.
...
#if defined(REAPERAPI_WANT_GetProjectStateChangeCount) ||                      \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_GetProjectTimeSignature) ||                         \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_GetProjectTimeSignature2) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // GetProjectTimeSignature2
    // Gets basic time signature (beats per minute, numerator of time signature
    // in bpi) this does not reflect tempo envelopes but is purely what is set
...
REAPERAPI_DEF //==============================================
    ...
    int (*GetProjExtState)(ReaProject *proj, const char *extname,
                           const char *key, char *valOutNeedBig,
...
REAPERAPI_DEF //==============================================
    ...
    // get a selected item by selected item count (zero-based) (proj=0 for
    // active project)
...
REAPERAPI_DEF //==============================================
              // GetSelectedTrack2
    // Get a selected track from a project (proj=0 for active project) by
    // selected track count (zero-based).

    MediaTrack *(*GetSelectedTrack2)(ReaProject *proj, int seltrackidx,
                                     bool wantmaster);
#endif

#if defined(REAPERAPI_WANT_GetSelectedTrackEnvelope) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // GetSelectedTrackEnvelope
    // get the currently selected track envelope, returns NULL/nil if no
...
REAPERAPI_DEF //==============================================
    ...
    void (*GetSet_ArrangeView2)(ReaProject *proj, bool isSet,
                                int screen_x_start, int screen_x_end,
                                double *start_timeOut, double *end_timeOut);
#endif
...
#if defined(REAPERAPI_WANT_GetSetAutomationItemInfo) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // GetSetAutomationItemInfo
    ...
    // any of the following: D_POOL_ID : double * : automation item pool ID (as
    // an integer); edits are propagated to all other automation items that
    // share a pool ID D_POSITION : double * : automation item timeline position
    // in seconds D_LENGTH : double * : automation item length in seconds
    ...
    // D_UISEL : double * : nonzero if the automation item is selected in the
    // arrange view D_POOL_QNLEN : double * : automation item pooled source
    // length in quarter notes (setting will affect all pooled instances)
    //
...
#if defined(REAPERAPI_WANT_GetSetAutomationItemInfo_String) ||                 \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // GetSetAutomationItemInfo_String
    // Get or set automation item information. autoitem_idx=0 for the first
    // automation item on an envelope, 1 for the second item, etc. returns true
    // on success. desc can be any of the following: P_POOL_NAME : char *, name
    // of the underlying automation item pool P_POOL_EXT:xyz : char *,
    // extension-specific persistent data
    //

    bool (*GetSetAutomationItemInfo_String)(TrackEnvelope *env,
                                            int autoitem_idx, const char *desc,
                                            char *valuestrNeedBig, bool is_set);
#endif

#if defined(REAPERAPI_WANT_GetSetEnvelopeInfo_String) ||                       \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    bool (*GetSetItemState2)(MediaItem *item, char *str, int str_sz,
                             bool isundo);
#endif
...
REAPERAPI_DEF //==============================================
    ...
    // free item positioning Y-position, 0=top of track, 1=bottom of track (will
    // never be 1) F_FREEMODE_H : float * : free item positioning height, 0=no
    // height, 1=full height of track (will never be 0) P_NOTES : char * : item
    // note text (do not write to returned pointer, use setNewValue to update)
    // P_EXT:xyz : char * : extension-specific persistent data
...
#if defined(REAPERAPI_WANT_GetSetMediaItemInfo_String) ||                      \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_GetSetMediaItemTakeInfo) ||                         \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
    ...
    // * : take name P_EXT:xyz : char * : extension-specific persistent data
    // GUID : GUID * : 16-byte GUID, can query or update. If using a _String()
    // function, GUID is a string {xyz-...}. D_STARTOFFS : double * : start
    // offset in source media, in seconds D_VOL : double * : take volume,
    // 0=-inf, 0.5=-6dB, 1=+0dB, 2=+6dB, etc, negative if take polarity is
    // flipped D_PAN : double * : take pan, -1..1 D_PANLAW : double * : take pan
    // law, -1=default, 0.5=-6dB, 1.0=+0dB, etc D_PLAYRATE : double * : take
    // playback rate, 0.5=half speed, 1=normal, 2=double speed, etc D_PITCH :
    // double * : take pitch adjustment in semitones, -12=one octave down,
    // 0=normal, +12=one octave up, etc B_PPITCH : bool * : preserve pitch when
    // changing playback rate I_CHANMODE : int * : channel mode, 0=normal,
    // 1=reverse stereo, 2=downmix, 3=left, 4=right I_PITCHMODE : int * : pitch
    // shifter mode, -1=projext default, otherwise high 2 bytes=shifter, low 2
    // bytes=parameter I_CUSTOMCOLOR : int * : custom color, OS dependent
    // color|0x100000 (i.e. ColorToNative(r,g,b)|0x100000). If you do not
    // |0x100000, then it will not be used, but will store the color
...
#if defined(REAPERAPI_WANT_GetSetMediaItemTakeInfo_String) ||                  \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // soloed, 1=soloed, 2=soloed in place, 5=safe soloed, 6=safe soloed in
    // place I_FXEN : int * : fx enabled, 0=bypassed, !0=fx active I_RECARM :
    // int * : record armed, 0=not record armed, 1=record armed I_RECINPUT : int
    ...
    // input (63=all, 62=VKB). If 4096 is not set, low 10 bits (0..1023) are
    // input start channel (ReaRoute/Loopback start at 512). If 2048 is set,
    // input is multichannel input (using track channel count), or if 1024 is
    // set, input is stereo input, otherwise input is mono. I_RECMODE : int * :
    ...
    // monitoring, 0=off, 1=normal, 2=not when playing (tape style)
    // I_RECMONITEMS : int * : monitor items while recording, 0=off, 1=on
    // I_AUTOMODE : int * : track automation mode, 0=trim/off, 1=read, 2=touch,
    // 3=write, 4=latch I_NCHAN : int * : number of track channels, 2-64, even
    // numbers only I_SELECTED : int * : track selected, 0=unselected,
    // 1=selected I_WNDH : int * : current TCP window height in pixels including
    // envelopes (read-only) I_TCPH : int * : current TCP window height in
    // pixels not including envelopes (read-only) I_TCPY : int * : current TCP
    // window Y-position in pixels relative to top of arrange view (read-only)
    // I_MCPX : int * : current MCP X-position in pixels relative to mixer
    // container I_MCPY : int * : current MCP Y-position in pixels relative to
    // mixer container I_MCPW : int * : current MCP width in pixels I_MCPH : int
    // * : current MCP height in pixels I_FOLDERDEPTH : int * : folder depth
    // change, 0=normal, 1=track is a folder parent, -1=track is the last in the
    // innermost folder, -2=track is the last in the innermost and
    // next-innermost folders, etc I_FOLDERCOMPACT : int * : folder compacted
    // state (only valid on folders), 0=normal, 1=small, 2=tiny children
    // I_MIDIHWOUT : int * : track midi hardware output index, <0=disabled, low
    // 5 bits are which channels (0=all, 1-16), next 5 bits are output device
    // index (0-31) I_PERFFLAGS : int * : track performance flags, &1=no media
    // buffering, &2=no anticipative FX I_CUSTOMCOLOR : int * : custom color, OS
    // dependent color|0x100000 (i.e. ColorToNative(r,g,b)|0x100000). If you do
    // not |0x100000, then it will not be used, but will store the color
    ...
    // of track, 0=-inf, 0.5=-6dB, 1=+0dB, 2=+6dB, etc D_PAN : double * : trim
    // pan of track, -1..1 D_WIDTH : double * : width of track, -1..1 D_DUALPANL
    // : double * : dualpan position 1, -1..1, only if I_PANMODE==6 D_DUALPANR :
    // double * : dualpan position 2, -1..1, only if I_PANMODE==6 I_PANMODE :
    // int * : pan mode, 0=classic 3.x, 3=new balance, 5=stereo pan, 6=dual pan
    ...
    // visible in mixer (do not use on master track) B_SHOWINTCP : bool * :
    // track control panel visible in arrange view (do not use on master track)
...
#if defined(REAPERAPI_WANT_GetSetMediaTrackInfo_String) ||                     \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
              // GetSetProjectGrid
              // Get or set the arrange view grid division. 0.25=quarter
    // note, 1.0/3.0=half note triplet, etc. swingmode can be 1 for swing
    // enabled, swingamt is -1..1. swingmode can be 3 for measure-grid. Returns
    // grid configuration flags
...
REAPERAPI_DEF //==============================================
    ...
    // RENDER_SETTINGS : &(1|2)=0:master mix, &1=stems+master mix, &2=stems
    // only, &4=multichannel tracks to multichannel files, &8=use render matrix,
    ...
    // RENDER_SRATE : sample rate of rendered file (or 0 for project sample
    // rate) RENDER_STARTPOS : render start time when RENDER_BOUNDSFLAG=0
    // RENDER_ENDPOS : render end time when RENDER_BOUNDSFLAG=0
    // RENDER_TAILFLAG : apply render tail setting when rendering: &1=custom
    // time bounds, &2=entire project, &4=time selection, &8=all project
    // regions, &16=selected media items, &32=selected project regions
    // RENDER_TAILMS : tail length in ms to render (only used if
    // RENDER_BOUNDSFLAG and RENDER_TAILFLAG are set) RENDER_ADDTOPROJ : &1=add
    // rendered files to project, &2=do not render files that are likely silent
    // RENDER_DITHER : &1=dither, &2=noise shaping, &4=dither stems, &8=noise
    // shaping on stems PROJECT_SRATE : samplerate (ignored unless
    // PROJECT_SRATE_USE set) PROJECT_SRATE_USE : set to 1 if project samplerate
    // is used
    //
...
#if defined(REAPERAPI_WANT_GetSetProjectInfo_String) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
    ...
    // necessarily the displayed number RECORD_PATH : recording directory -- may
    // be blank or a relative path, to get the effective path see
    // GetProjectPathEx() RENDER_FILE : render directory RENDER_PATTERN : render
    // file name (may contain wildcards) RENDER_METADATA : get or set the
    // metadata saved with the project (not metadata embedded in project media).
    // Example, ID3 album name metadata: "ID3:TALB" to get, "ID3:TALB|my album
    // name" to set. RENDER_TARGETS : semicolon separated list of files that
    // would be written if the project is rendered using the most recent render
    // settings RENDER_FORMAT : base64-encoded sink configuration (see project
    // files, etc). Callers can also pass a simple 4-byte string
    // (non-base64-encoded), e.g. "evaw" or "l3pm", to use default settings for
    // that sink type. RENDER_FORMAT2 : base64-encoded secondary sink
    // configuration. Callers can also pass a simple 4-byte string
    // (non-base64-encoded), e.g. "evaw" or "l3pm", to use default settings for
...
#if defined(REAPERAPI_WANT_GetSetTrackGroupMembership) ||                      \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_GetSetTrackGroupMembershipHigh) ||                  \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_GetSetTrackMIDISupportFile) ||                      \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // GetSetTrackMIDISupportFile
              // Get or set the filename for storage of various track MIDI
    // characteristics. 0=MIDI colormap image file, 1 or 2=MIDI bank/program
    // select file (2=set new default). If fn != NULL, a new track MIDI storage
    // file will be set; otherwise the existing track MIDI storage file will be
    // returned.

    const char *(*GetSetTrackMIDISupportFile)(ReaProject *proj,
                                              MediaTrack *track, int which,
                                              const char *filename);
#endif
...
REAPERAPI_DEF //==============================================
    ...
    //  sendidx is 0..n (to enumerate, iterate over sendidx until it returns
    //  NULL)
    // parameter names:
    ...
    // source track, only applies for sends/recvs P_ENV:<envchunkname : read
    // only, returns TrackEnvelope *. Call with :<VOLENV, :<PANENV, etc
    // appended. P_EXT:xyz : char * : extension-specific persistent data B_MUTE
    // : bool * B_PHASE : bool *, true to flip phase B_MONO : bool * D_VOL :
    // double *, 1.0 = +0dB etc D_PAN : double *, -1..+1 D_PANLAW : double
    // *,1.0=+0.0db, 0.5=-6dB, -1.0 = projdef etc I_SENDMODE : int *,
    // 0=post-fader, 1=pre-fx, 2=post-fx (deprecated), 3=post-fx I_AUTOMODE :
    // int * : automation mode (-1=use track automode, 0=trim/off, 1=read,
    // 2=touch, 3=write, 4=latch) I_SRCCHAN : int *, index,&1024=mono, -1 for
    // none I_DSTCHAN : int *, index, &1024=mono, otherwise stereo pair,
    // hwout:&512=rearoute I_MIDIFLAGS : int *, low 5 bits=source channel 0=all,
    // 1-16, next 5 bits=dest channel, 0=orig, 1-16=chanSee CreateTrackSend,
    // RemoveTrackSend.
...
#if defined(REAPERAPI_WANT_GetSetTrackSendInfo_String) ||                      \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
    ...
    bool (*GetSetTrackSendInfo_String)(MediaTrack *tr, int category,
                                       int sendidx, const char *parmname,
                                       char *stringNeedBig, bool setNewValue);
#endif
...
#if defined(REAPERAPI_WANT_GetSubProjectFromSource) ||                         \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_GetTakeNumStretchMarkers) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // srcposOutOptional will be set to source media position. Returns index. if
    // input index is -1, next marker is found using position (or source
    // position if position is -1). If position/source position are used to find
    // marker position, their values are not updated.

    int (*GetTakeStretchMarker)(MediaItem_Take *take, int idx, double *posOut,
                                double *srcposOutOptional);
#endif

#if defined(REAPERAPI_WANT_GetTakeStretchMarkerSlope) ||                       \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    bool (*GetTempoTimeSigMarker)(ReaProject *proj, int ptidx,
                                  double *timeposOut, int *measureposOut,
                                  double *beatposOut, double *bpmOut,
...
#if defined(REAPERAPI_WANT_GetToggleCommandState2) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_GetToggleCommandStateEx) ||                         \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_GetToggleCommandStateThroughHooks) ||               \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
              // GetTooltipWindow
    // gets a tooltip window,in case you want to ask it for font information.
    // Can return NULL.
...
#if defined(REAPERAPI_WANT_GetTrackAutomationMode) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_GetTrackEnvelopeByChunkName) ||                     \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_GetTrackEnvelopeByName) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // measure and triple tabs when skipping measures, flag&2: each lyric is
    // preceded by its beat position in the project (example with flag=2:
    // "1.1.2\tLyric for measure 1 beat 2\t.1.1\tLyric for measure 2 beat 1
    // "). See SetTrackMIDILyrics

    bool (*GetTrackMIDILyrics)(MediaTrack *track, int flag,
                               char *bufWantNeedBig, int *bufWantNeedBig_sz);
#endif
...
#if defined(REAPERAPI_WANT_GetTrackMIDINoteNameEx) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_GetTrackReceiveUIVolPan) ||                         \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_GetTrackSendInfo_Value) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
    ...
    // 1-16=chanP_DESTTRACK : read only, returns MediaTrack *, destination
    // track, only applies for sends/recvs P_SRCTRACK : read only, returns
    // MediaTrack *, source track, only applies for sends/recvs
    // P_ENV:<envchunkname : read only, returns TrackEnvelope *. Call with
    // :<VOLENV, :<PANENV, etc appended. See CreateTrackSend, RemoveTrackSend,
    // GetTrackNumSends.
...
REAPERAPI_DEF //==============================================
    ...
    bool (*GetTrackSendUIMute)(MediaTrack *track, int send_index,
                               bool *muteOut);
#endif
...
REAPERAPI_DEF //==============================================
              // GetTrackStateChunk
    // Gets the RPPXML state of a track, returns true if successful. Undo flag
    // is a performance/caching hint.
...
#if defined(REAPERAPI_WANT_GetUserFileNameForRead) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // GetUserFileNameForRead
    // returns true if the user selected a valid file, false if the user
    // canceled the dialog
...
REAPERAPI_DEF //==============================================
    ...
    // not display the input text. Maximum fields is 16. Values are returned as
    // a comma-separated string. Returns false if the user canceled the dialog.
    // You can supply special extra information via additional caption fields:
    // extrawidth=XXX to increase text field width, separator=X to use a
    // different separator for returned fields.
...
REAPERAPI_DEF //==============================================
    ...
    // first marker on the timeline.  If use_timeline_order==false, marker_index
    // 1 refers to the first marker with the user-editable index of 1.
...
REAPERAPI_DEF //==============================================
    ...
    // the timeline.  If use_timeline_order==false, region_index 1 refers to the
    // first region with the user-editable index of 1.
...
REAPERAPI_DEF //==============================================
              // HasExtState
    // Returns true if there exists an extended state value for a specific
    // section and key. See SetExtState, GetExtState, DeleteExtState.
...
#if defined(REAPERAPI_WANT_HasTrackMIDIProgramsEx) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // points into the automation item; if pool_id is >= 0 the automation item
    // will be a new instance of that pool (which will be created as an empty
    // instance if it does not exist). Returns the index of the item, suitable
    // for passing to other automation item API functions. See
    // GetSetAutomationItemInfo.

    int (*InsertAutomationItem)(TrackEnvelope *env, int pool_id,
...
REAPERAPI_DEF //==============================================
    ...
    // be based on the number of visible points in the automation item,
    // including all loop iterations. See CountEnvelopePointsEx,
    // GetEnvelopePointEx, SetEnvelopePointEx, DeleteEnvelopePointEx.
...
REAPERAPI_DEF //==============================================
    ...
    // &256=force loop regardless of global preference for looping imported
    // items, &512=use high word as absolute track index if mode&3==0,
    // &1024=insert into reasamplomatic on a new track, &2048=insert into open
    // reasamplomatic instance, &4096=move to source preferred position (BWF
    // start offset), &8192=reverse
...
REAPERAPI_DEF //==============================================
              // IsInRealTimeAudio
    // are we in a realtime audio thread (between OnAudioBuffer calls,not in
    // some worker/anticipative FX thread)? threadsafe

    int (*IsInRealTimeAudio)();
#endif

#if defined(REAPERAPI_WANT_IsItemTakeActiveForPlayback) ||                     \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_joystick_getbuttonmask) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // This function is poorly named as it doesn't return the command's name,
    // see kbd_getTextFromCmd.
...
REAPERAPI_DEF //==============================================
    ...
    int (*KBD_OnMainActionEx)(int cmd, int val, int valhw, int relmode,
                              HWND hwnd, ReaProject *proj);
#endif
...
#if defined(REAPERAPI_WANT_kbd_ProcessActionsMenu) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_kbd_processMidiEventActionEx) ||                    \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
              // kbd_reprocessMenu
    // Reprocess a menu recursively, setting key assignments to what their
    // command IDs are mapped to.

    void (*kbd_reprocessMenu)(HMENU menu, KbdSectionInfo *section);
#endif

#if defined(REAPERAPI_WANT_kbd_RunCommandThroughHooks) ||                      \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
    ...
    bool (*kbd_RunCommandThroughHooks)(KbdSectionInfo *section,
                                       int *actionCommandID, int *val,
                                       int *valhw, int *relmode, HWND hwnd);
#endif

#if defined(REAPERAPI_WANT_kbd_translateAccelerator) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // kbd_translateAccelerator
    // Pass in the HWND to receive commands, a MSG of a key command,  and a
    // valid section, and kbd_translateAccelerator() will process it looking for
    // any keys bound to it, and send the messages off. Returns 1 if processed,
    // 0 if no key binding found.

    int (*kbd_translateAccelerator)(HWND hwnd, MSG *msg,
...
#if defined(REAPERAPI_WANT_LICE__SetTextCombineMode) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    void (*LICE_BorderedRect)(LICE_IBitmap *dest, int x, int y, int w, int h,
                              LICE_pixel bgcolor, LICE_pixel fgcolor,
...
#if defined(REAPERAPI_WANT_LICE_FillConvexPolygon) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    void (*LICE_FillTriangle)(LICE_IBitmap *dest, int x1, int y1, int x2,
                              int y2, int x3, int y3, LICE_pixel color,
                              float alpha, int mode);
#endif
...
REAPERAPI_DEF //==============================================
    ...
    void (*LICE_Line)(LICE_IBitmap *dest, float x1, float y1, float x2,
                      float y2, LICE_pixel color, float alpha, int mode,
                      bool aa);
#endif
...
#if defined(REAPERAPI_WANT_LICE_LoadPNGFromResource) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    void (*LICE_RotatedBlit)(LICE_IBitmap *dest, LICE_IBitmap *src, int dstx,
                             int dsty, int dstw, int dsth, float srcx,
                             float srcy, float srcw, float srch, float angle,
...
REAPERAPI_DEF //==============================================
    ...
    void (*LICE_RoundRect)(LICE_IBitmap *drawbm, float xpos, float ypos,
                           float w, float h, int cornerradius, LICE_pixel col,
                           float alpha, int mode, bool aa);
#endif
...
REAPERAPI_DEF //==============================================
    ...
    void (*LICE_ScaledBlit)(LICE_IBitmap *dest, LICE_IBitmap *src, int dstx,
                            int dsty, int dstw, int dsth, float srcx,
                            float srcy, float srcw, float srch, float alpha,
                            int mode);
#endif
...
REAPERAPI_DEF //==============================================
    ...
    void (*LICE_SimpleFill)(LICE_IBitmap *dest, int x, int y,
                            LICE_pixel newcolor, LICE_pixel comparemask,
                            LICE_pixel keepmask);
#endif
...
REAPERAPI_DEF //==============================================
    ...
    // with 'noprompt:'. If name is prefixed with 'template:', project file will
    // be loaded as a template. If passed a .RTrackTemplate file, adds the
    // template to the existing project.
...
#if defined(REAPERAPI_WANT_Master_GetPlayRateAtTime) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_Master_NormalizePlayRate) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // Convert the tempo to/from a value between 0 and 1, representing bpm in
    // the range of 40-296 bpm.
...
#if defined(REAPERAPI_WANT_MediaItemDescendsFromTrack) ||                      \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
              // MIDI_CountEvts
    // Count the number of notes, CC events, and text/sysex events in a given
    // MIDI item.

    int (*MIDI_CountEvts)(MediaItem_Take *take, int *notecntOut,
                          int *ccevtcntOut, int *textsyxevtcntOut);
#endif
...
#if defined(REAPERAPI_WANT_MIDI_DeleteTextSysexEvt) ||                         \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
              // MIDI_EnumSelEvts
    // Returns the index of the next selected MIDI event after evtidx (-1 if
    // there are no more selected events).
...
REAPERAPI_DEF //==============================================
              // MIDI_EnumSelNotes
    // Returns the index of the next selected MIDI note after noteidx (-1 if
    // there are no more selected events).

    int (*MIDI_EnumSelNotes)(MediaItem_Take *take, int noteidx);
#endif

#if defined(REAPERAPI_WANT_MIDI_EnumSelTextSysexEvts) ||                       \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // previous event flag: &1=selected &2=muted flag high 4 bits for CC shape:
    // &16=linear, &32=slow start/end, &16|32=fast start, &64=fast end,
    // &64|16=bezier msg: the MIDI message. A meta-event of type 0xF followed by
    // 'CCBZ ' and 5 more bytes represents bezier curve data for the previous
    // MIDI event: 1 byte for the bezier type (usually 0) and 4 bytes for the
    // bezier tension as a float. For tick intervals longer than a 32 bit word
    // can represent, zero-length meta events may be placed between valid
...
#if defined(REAPERAPI_WANT_MIDI_GetPPQPos_EndOfMeasure) ||                     \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_MIDI_GetPPQPos_StartOfMeasure) ||                   \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
    ...
    double (*MIDI_GetPPQPos_StartOfMeasure)(MediaItem_Take *take,
                                            double ppqpos);
#endif

#if defined(REAPERAPI_WANT_MIDI_GetPPQPosFromProjQN) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_MIDI_GetPPQPosFromProjTime) ||                      \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_MIDI_GetProjQNFromPPQPos) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // MIDI_GetProjQNFromPPQPos
    // Returns the project time in quarter notes corresponding to a specific
    // MIDI tick (ppq) position.

    double (*MIDI_GetProjQNFromPPQPos)(MediaItem_Take *take, double ppqpos);
#endif

#if defined(REAPERAPI_WANT_MIDI_GetProjTimeFromPPQPos) ||                      \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    bool (*MIDI_GetTextSysexEvt)(MediaItem_Take *take, int textsyxevtidx,
                                 ...
                                 int *typeOutOptional, char *msgOptional,
                                 int *msgOptional_sz);
#endif
...
REAPERAPI_DEF //==============================================
              // MIDI_InsertNote
    // Insert a new MIDI note. Set noSort if inserting multiple events, then
...
#if defined(REAPERAPI_WANT_MIDI_InsertTextSysexEvt) ||                         \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // not be set. Allowable types are -1:sysex (msg should not include bounding
...
REAPERAPI_DEF //==============================================
    ...
    // MIDIEditor_SetSetting_int, MIDIEditor_GetActive,
...
#if defined(REAPERAPI_WANT_MIDIEditor_GetSetting_str) ||                       \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // MIDIEditor_GetSetting_str
              // Get settings from a MIDI editor. setting_desc can be:
...
#if defined(REAPERAPI_WANT_MIDIEditor_LastFocused_OnCommand) ||                \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // MIDI editor pointer is not valid (not an open MIDI editor). see
    // MIDIEditor_GetActive, MIDIEditor_LastFocused_OnCommand

    bool (*MIDIEditor_OnCommand)(HWND midieditor, int command_id);
#endif

#if defined(REAPERAPI_WANT_MIDIEditor_SetSetting_int) ||                       \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // extension such as "_SWS_ABOUT" or "_113088d11ae641c193a2b7ede3041ad5" for
    // a ReaScript or a custom action.
...
REAPERAPI_DEF //==============================================
    ...
    double (*parse_timestr_len)(const char *buf, double offset,
                                int modeoverride);
#endif
...
#if defined(REAPERAPI_WANT_PCM_Sink_CreateMIDIFile) ||                         \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_PCM_Sink_CreateMIDIFileEx) ||                       \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // PCM_Sink_CreateMIDIFileEx

    PCM_sink *(*PCM_Sink_CreateMIDIFileEx)(ReaProject *proj,
                                           const char *filename,
...
#if defined(REAPERAPI_WANT_PCM_Source_CreateFromFile) ||                       \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_PCM_Source_CreateFromSimple) ||                     \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_PCM_Source_CreateFromType) ||                       \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    int (*PCM_Source_GetPeaks)(PCM_source *src, double peakrate,
                               double starttime, int numchannels,
                               int numsamplesperchannel, int want_extra_type,
                               double *buf);
#endif

#if defined(REAPERAPI_WANT_PCM_Source_GetSectionInfo) ||                       \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // buffering. measure_align<0=play immediately, >0=align playback with
    // measure start
...
#if defined(REAPERAPI_WANT_plugin_getImportableProjectFilterList) ||           \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // plugin_getImportableProjectFilterList
    // Returns a double-NULL terminated list of importable project files,
...
#if defined(REAPERAPI_WANT_PluginWantsAlwaysRunFx) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_projectconfig_var_addr) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_projectconfig_var_getoffs) ||                       \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // create a session (init_id will be the initial action to select, or 0),
    // then poll with session_mode=0, checking return value for user-selected
    // action (will return 0 if no action selected yet, or -1 if the action
    // window is no longer available). When finished, call with session_mode=-1.
...
REAPERAPI_DEF //==============================================
              // realloc_cmd_ptr
    // special use for NeedBig script API functions - reallocates a NeedBig
    // buffer and updates its size, returns false on error

    bool (*realloc_cmd_ptr)(char **ptr, int *ptr_size, int new_size);
#endif

#if defined(REAPERAPI_WANT_ReaperGetPitchShiftAPI) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // is <0 for receives, 0=sends, >0 for hardware outputs. See
    // CreateTrackSend, GetSetTrackSendInfo, GetTrackSendInfo_Value,
...
#if defined(REAPERAPI_WANT_ReverseNamedCommandLookup) ||                       \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    void (*screenset_registerNew)(char *id,
...
#if defined(REAPERAPI_WANT_screenset_unregisterByParam) ||                     \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_screenset_updateLastFocus) ||                       \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // Set attributes of an envelope point. Values that are not supplied will be
    // ignored. If setting multiple points at once, set noSort=true, and call
    // Envelope_SortPoints when done. autoitem_idx=-1 for the underlying
    // envelope, 0 for the first automation item on the envelope, etc. For
    // automation items, pass autoitem_idx|0x10000000 to base ptidx on the
    // number of points in one full loop iteration, even if the automation item
    // is trimmed so that not all points are visible. Otherwise, ptidx will be
    // based on the number of visible points in the automation item, including
...
REAPERAPI_DEF //==============================================
    ...
    // Sets the RPPXML state of an envelope, returns true if successful. Undo
    // flag is a performance/caching hint.
...
#if defined(REAPERAPI_WANT_SetGlobalAutomationOverride) ||                     \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
              // SetItemStateChunk
    // Sets the RPPXML state of an item, returns true if successful. Undo flag
    // is a performance/caching hint.
...
#if defined(REAPERAPI_WANT_SetMasterTrackVisibility) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_SetMediaItemInfo_Value) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
    ...
    // free item positioning Y-position, 0=top of track, 1=bottom of track (will
    // never be 1) F_FREEMODE_H : float * : free item positioning height, 0=no
    // height, 1=full height of track (will never be 0)
    //
...
#if defined(REAPERAPI_WANT_SetMediaItemTake_Source) ||                         \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_SetMediaItemTakeInfo_Value) ||                      \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
    ...
    bool (*SetMediaItemTakeInfo_Value)(MediaItem_Take *take,
                                       const char *parmname, double newvalue);
#endif

#if defined(REAPERAPI_WANT_SetMediaTrackInfo_Value) ||                         \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // strings by modifying an assignment in Preferences/Editing/Mouse
    // Modifiers, then looking in reaper-mouse.ini. Modifier flag is a number
    // from 0 to 15: add 1 for shift, 2 for control, 4 for alt, 8 for win.
    // (macOS: add 1 for shift, 2 for command, 4 for opt, 8 for control.)
    // For left-click and double-click contexts, the action can be any built-in
    // command ID number or any custom action ID string. Find built-in command
    // IDs in the REAPER actions window (enable "show action IDs" in the context
    // menu), and find custom action ID strings in reaper-kb.ini. For built-in
    // mouse modifier behaviors, find action IDs (which will be low numbers) by
    // modifying an assignment in Preferences/Editing/Mouse Modifiers, then
    // looking in reaper-mouse.ini. Assigning an action of -1 will reset that
    // mouse modifier behavior to factory default. See GetMouseModifier.
    //
...
#if defined(REAPERAPI_WANT_SetProjectMarkerByIndex) ||                         \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // SetProjectMarkerByIndex
              // See SetProjectMarkerByIndex2.

    bool (*SetProjectMarkerByIndex)(ReaProject *proj, int markrgnidx,
                                    bool isrgn, double pos, double rgnend,
                                    int IDnumber, const char *name, int color);
#endif

#if defined(REAPERAPI_WANT_SetProjectMarkerByIndex2) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
    ...
    // representing the displayed marker/region ID number (see
    // SetProjectMarker3). Function will fail if attempting to set a duplicate
    // ID number for a region (duplicate ID numbers for markers are OK). ,
    // flags&1 to clear name.

    bool (*SetProjectMarkerByIndex2)(ReaProject *proj, int markrgnidx,
                                     bool isrgn, double pos, double rgnend,
                                     int IDnumber, const char *name, int color,
                                     int flags);
#endif
...
REAPERAPI_DEF //==============================================
    ...
    int (*SetProjExtState)(ReaProject *proj, const char *extname,
...
REAPERAPI_DEF //==============================================
    ...
    // Add (addorremove > 0) or remove (addorremove < 0) a track from this
    // region when using the region render matrix.
...
REAPERAPI_DEF //==============================================
    ...
    // otherwise an existing take marker will be updated. Returns the index of
    // the new or updated take marker (which may change if srcPos is updated).
...
REAPERAPI_DEF //==============================================
    ...
    // If idx>=0, stretch marker will be updated. When adding, if
    ...
    // nearby stretch markers. Returns index of stretch marker, or -1 if did not
    // insert (or marker already existed at time).

    int (*SetTakeStretchMarker)(MediaItem_Take *take, int idx, double pos,
                                const double *srcposInOptional);
#endif

#if defined(REAPERAPI_WANT_SetTakeStretchMarkerSlope) ||                       \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // default color if -1 is specified). Returns -1 on failure, otherwise
    // returns the color (or transformed-color). Note that the UI is not updated
    // by this, the caller should call UpdateArrange() etc as necessary. If the
    // low bit of flags is set, any color transformations are bypassed. To read
    // a value see GetThemeColor.
...
#if defined(REAPERAPI_WANT_SetTrackAutomationMode) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // position, tab, text, tab (example with flag=2: "1.1.2\tLyric for measure
    // 1 beat 2\t.1.1\tLyric for measure 2 beat 1	"). See
    // GetTrackMIDILyrics
...
#if defined(REAPERAPI_WANT_SetTrackMIDINoteNameEx) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // SetTrackMIDINoteNameEx
    ...
    bool (*SetTrackMIDINoteNameEx)(ReaProject *proj, MediaTrack *track,
                                   int pitch, int chan, const char *name);
#endif
...
#if defined(REAPERAPI_WANT_SetTrackSendInfo_Value) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // SetTrackSendInfo_Value
    // Set send/receive/hardware output numerical-value attributes, return true
    // on success. category is <0 for receives, 0=sends, >0 for hardware outputs
    // parameter names:
    // B_MUTE : bool *
    // B_PHASE : bool *, true to flip phase
    // B_MONO : bool *
...
REAPERAPI_DEF //==============================================
              // SetTrackStateChunk
    // Sets the RPPXML state of a track, returns true if successful. Undo flag
    // is a performance/caching hint.
...
REAPERAPI_DEF //==============================================
    ...
    // pointer for item* (but is optional). for envelope_point, ctx2Optional has
    // point index, ctx3Optional has item index (0=main envelope, 1=first AI).
    // for envelope_item, ctx2Optional has AI index (1=first AI)

    void (*ShowPopupMenu)(const char *name, int x, int y,
                          HWND hwndParentOptional, void *ctxOptional,
                          int ctx2Optional, int ctx3Optional);
#endif
...
#if defined(REAPERAPI_WANT_TakeFX_FormatParamValue) ||                         \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_TakeFX_FormatParamValueNormalized) ||               \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_TakeFX_GetChainVisible) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // TakeFX_GetChainVisible
    // returns index of effect visible in chain, or -1 for chain hidden, or -2
    // for chain visible but no effect selected
...
#if defined(REAPERAPI_WANT_TakeFX_GetFloatingWindow) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_TakeFX_GetFormattedParamValue) ||                   \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // TakeFX_GetFormattedParamValue

    bool (*TakeFX_GetFormattedParamValue)(MediaItem_Take *take, int fx,
                                          int param, char *buf, int buf_sz);
#endif
...
REAPERAPI_DEF //==============================================
    ...
    bool (*TakeFX_GetFXName)(MediaItem_Take *take, int fx, char *buf,
                             int buf_sz);
#endif
...
#if defined(REAPERAPI_WANT_TakeFX_GetNamedConfigParm) ||                       \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // TakeFX_GetNamedConfigParm
    // gets plug-in specific named configuration value (returns true on
    // success). see TrackFX_GetNamedConfigParm
...
#if defined(REAPERAPI_WANT_TakeFX_GetParameterStepSizes) ||                    \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // TakeFX_GetParameterStepSizes

    bool (*TakeFX_GetParameterStepSizes)(MediaItem_Take *take, int fx,
                                         int param, double *stepOut,
                                         double *smallstepOut,
                                         double *largestepOut,
                                         bool *istoggleOut);
#endif
...
#if defined(REAPERAPI_WANT_TakeFX_GetParamNormalized) ||                       \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // TakeFX_GetParamNormalized

    double (*TakeFX_GetParamNormalized)(MediaItem_Take *take, int fx,
                                        int param);
#endif
...
REAPERAPI_DEF //==============================================
    ...
    // preset (in other words, if the user loaded the preset but moved the knobs
    // afterward). See TakeFX_SetPreset.
...
#if defined(REAPERAPI_WANT_TakeFX_GetUserPresetFilename) ||                    \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_TakeFX_NavigatePresets) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
    ...
    bool (*TakeFX_NavigatePresets)(MediaItem_Take *take, int fx,
                                   int presetmove);
#endif
...
#if defined(REAPERAPI_WANT_TakeFX_SetNamedConfigParm) ||                       \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    bool (*TakeFX_SetParam)(MediaItem_Take *take, int fx, int param,
                            double val);
#endif

#if defined(REAPERAPI_WANT_TakeFX_SetParamNormalized) ||                       \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // to .vstpreset files are also supported for VST3 plug-ins. See
    // TakeFX_GetPreset.
...
#if defined(REAPERAPI_WANT_TakeFX_SetPresetByIndex) ||                         \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_ThemeLayout_GetParameter) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
    ...
    const char *(*ThemeLayout_GetParameter)(int wp,
...
#if defined(REAPERAPI_WANT_ThemeLayout_RefreshAll) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_ThemeLayout_SetParameter) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_TimeMap2_GetDividedBpmAtTime) ||                    \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_TimeMap2_GetNextChangeTime) ||                      \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // if measures is non-NULL, measures will be set to the measure count,
    // return value will be beats since measure. if cml is non-NULL, will be set
    // to current measure length in beats (i.e. time signature numerator) if
...
REAPERAPI_DEF //==============================================
    ...
    double (*TimeMap_curFrameRate)(ReaProject *proj,
                                   bool *dropFrameOutOptional);
#endif

#if defined(REAPERAPI_WANT_TimeMap_GetDividedBpmAtTime) ||                     \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_TimeMap_GetMeasureInfo) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_TimeMap_GetMetronomePattern) ||                     \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // TimeMap_GetMetronomePattern
    // Fills in a string representing the active metronome pattern. For example,
    // in a 7/8 measure divided 3+4, the pattern might be "1221222". The length
    // of the string is the time signature numerator, and the function returns
...
#if defined(REAPERAPI_WANT_TimeMap_GetTimeSigAtTime) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // create a new effect, 0 to only query the first instance of an effect, or
    // a positive value to add an instance if one is not found. If instantiate
    // is <= -1000, it is used for the insertion position (-1000 is first item
    // in chain, -1001 is second, etc). fxname can have prefix to specify type:
    // VST3:,VST2:,VST:,AU:,JS:, or DX:, or FXADD: which adds selected items
    // from the currently-open FX browser, FXADD:2 to limit to 2 FX added, or
    // FXADD:2e to only succeed if exactly 2 FX are selected. Returns -1 on
    // failure or the new position in chain on success.
...
REAPERAPI_DEF //==============================================
              // TrackFX_CopyToTake
    // Copies (or moves) FX from src_track to dest_take. src_fx can have
    // 0x1000000 set to reference input FX.
...
#if defined(REAPERAPI_WANT_TrackFX_FormatParamValue) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_TrackFX_FormatParamValueNormalized) ||              \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_TrackFX_GetChainVisible) ||                         \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
              // TrackFX_GetEQ
    // Get the index of ReaEQ in the track FX chain. If ReaEQ is not in the
    // chain and instantiate is true, it will be inserted. See
    // TrackFX_GetInstrument, TrackFX_GetByName.

    int (*TrackFX_GetEQ)(MediaTrack *track, bool instantiate);
#endif

#if defined(REAPERAPI_WANT_TrackFX_GetEQBandEnabled) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
    ...
    // Bandidx: 0=first band matching bandtype, 1=2nd band matching bandtype,
    // etc. See TrackFX_GetEQ, TrackFX_GetEQParam, TrackFX_SetEQParam,
...
REAPERAPI_DEF //==============================================
    ...
    // Bandtype: -1=master gain, 0=lhipass, 1=loshelf, 2=band, 3=notch,
    // 4=hishelf, 5=lopass. Bandidx (ignored for master gain): 0=first band
    // matching bandtype, 1=2nd band matching bandtype, etc. Paramtype (ignored
    // for master gain): 0=freq, 1=gain, 2=Q. See TrackFX_GetEQ,
    // TrackFX_SetEQParam, TrackFX_GetEQBandEnabled, TrackFX_SetEQBandEnabled.
...
#if defined(REAPERAPI_WANT_TrackFX_GetFloatingWindow) ||                       \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_TrackFX_GetFormattedParamValue) ||                  \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // Get the index of the first track FX insert that is a virtual instrument,
    // or -1 if none. See TrackFX_GetEQ, TrackFX_GetByName.
...
REAPERAPI_DEF //==============================================
    ...
    int (*TrackFX_GetIOSize)(MediaTrack *track, int fx,
                             int *inputPinsOutOptional,
                             int *outputPinsOutOptional);
#endif

#if defined(REAPERAPI_WANT_TrackFX_GetNamedConfigParm) ||                      \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // TrackFX_GetNamedConfigParm
    // gets plug-in specific named configuration value (returns true on
    // success). Special values: 'pdc' returns PDC latency. 'in_pin_0' returns
    // name of first input pin (if available), 'out_pin_0' returns name of first
    // output pin (if available), etc.
...
#if defined(REAPERAPI_WANT_TrackFX_GetParameterStepSizes) ||                   \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    bool (*TrackFX_GetParamName)(MediaTrack *track, int fx, int param,
                                 char *buf, int buf_sz);
#endif
...
#if defined(REAPERAPI_WANT_TrackFX_GetPinMappings) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // Returns false if the current FX parameters do not exactly match the
    // preset (in other words, if the user loaded the preset but moved the knobs
    // afterward). See TrackFX_SetPreset.
...
#if defined(REAPERAPI_WANT_TrackFX_GetRecChainVisible) ||                      \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_TrackFX_GetUserPresetFilename) ||                   \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_TrackFX_NavigatePresets) ||                         \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_TrackFX_SetEQBandEnabled) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
              // TrackFX_SetEQBandEnabled
...
REAPERAPI_DEF //==============================================
    ...
    // bandtype. Bandtype: -1=master gain, 0=lhipass, 1=loshelf, 2=band,
    // 3=notch, 4=hishelf, 5=lopass. Bandidx (ignored for master gain): 0=target
    // first band matching bandtype, 1=target 2nd band matching bandtype, etc.
...
#if defined(REAPERAPI_WANT_TrackFX_SetNamedConfigParm) ||                      \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_TrackFX_SetPinMappings) ||                          \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
    ...
    bool (*TrackFX_SetPinMappings)(MediaTrack *tr, int fx, int isoutput,
                                   int pin, int low32bits, int hi32bits);
#endif
...
REAPERAPI_DEF //==============================================
    ...
    bool (*TrackFX_SetPreset)(MediaTrack *track, int fx,
                              const char *presetname);
#endif

#if defined(REAPERAPI_WANT_TrackFX_SetPresetByIndex) ||                        \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_TrackList_AdjustWindows) ||                         \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_TrackList_UpdateAllExternalSurfaces) ||             \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_Undo_OnStateChange_Item) ||                         \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
REAPERAPI_DEF //==============================================
    ...
    // notify REAPER of a write error by calling with readamt=0,
    // writeamt=-101010110 for unknown or -101010111 for disk full
...
REAPERAPI_DEF //==============================================
    ...
    bool (*ValidatePtr2)(ReaProject *proj, void *pointer,
...
#if defined(REAPERAPI_WANT_WDL_VirtualWnd_ScaledBlitBG) ||                     \
    !defined(REAPERAPI_MINIMAL)
REAPERAPI_DEF //==============================================
...
#if defined(REAPERAPI_WANT_GetSetAutomationItemInfo_String) ||                 \
    !defined(REAPERAPI_MINIMAL)
    {(void **)&GetSetAutomationItemInfo_String,
     "GetSetAutomationItemInfo_String"},
#endif
#if defined(REAPERAPI_WANT_GetSetEnvelopeInfo_String) ||                       \
    !defined(REAPERAPI_MINIMAL)
...
#if defined(REAPERAPI_WANT_GetSetMediaItemTakeInfo_String) ||                  \
    !defined(REAPERAPI_MINIMAL)
    {(void **)&GetSetMediaItemTakeInfo_String,
     "GetSetMediaItemTakeInfo_String"},
#endif
#if defined(REAPERAPI_WANT_GetSetMediaTrackInfo) || !defined(REAPERAPI_MINIMAL)
...
#if defined(REAPERAPI_WANT_GetSetTrackGroupMembershipHigh) ||                  \
    !defined(REAPERAPI_MINIMAL)
    {(void **)&GetSetTrackGroupMembershipHigh,
     "GetSetTrackGroupMembershipHigh"},
#endif
#if defined(REAPERAPI_WANT_GetSetTrackMIDISupportFile) ||                      \
    !defined(REAPERAPI_MINIMAL)
...
#if defined(REAPERAPI_WANT_GetToggleCommandStateThroughHooks) ||               \
    !defined(REAPERAPI_MINIMAL)
    {(void **)&GetToggleCommandStateThroughHooks,
     "GetToggleCommandStateThroughHooks"},
#endif
#if defined(REAPERAPI_WANT_GetTooltipWindow) || !defined(REAPERAPI_MINIMAL)
...
#if defined(REAPERAPI_WANT_MIDIEditor_LastFocused_OnCommand) ||                \
    !defined(REAPERAPI_MINIMAL)
    {(void **)&MIDIEditor_LastFocused_OnCommand,
     "MIDIEditor_LastFocused_OnCommand"},
#endif
#if defined(REAPERAPI_WANT_MIDIEditor_OnCommand) || !defined(REAPERAPI_MINIMAL)
...
#if defined(REAPERAPI_WANT_plugin_getImportableProjectFilterList) ||           \
    !defined(REAPERAPI_MINIMAL)
    {(void **)&plugin_getImportableProjectFilterList,
     "plugin_getImportableProjectFilterList"},
#endif
#if defined(REAPERAPI_WANT_plugin_register) || !defined(REAPERAPI_MINIMAL)
...
#if defined(REAPERAPI_WANT_TakeFX_FormatParamValueNormalized) ||               \
    !defined(REAPERAPI_MINIMAL)
    {(void **)&TakeFX_FormatParamValueNormalized,
     "TakeFX_FormatParamValueNormalized"},
#endif
#if defined(REAPERAPI_WANT_TakeFX_GetChainVisible) ||                          \
    !defined(REAPERAPI_MINIMAL)
...
#if defined(REAPERAPI_WANT_TrackFX_FormatParamValueNormalized) ||              \
    !defined(REAPERAPI_MINIMAL)
    {(void **)&TrackFX_FormatParamValueNormalized,
     "TrackFX_FormatParamValueNormalized"},
#endif
#if defined(REAPERAPI_WANT_TrackFX_GetByName) || !defined(REAPERAPI_MINIMAL)
...
#if defined(REAPERAPI_WANT_TrackFX_GetFormattedParamValue) ||                  \
    !defined(REAPERAPI_MINIMAL)
    {(void **)&TrackFX_GetFormattedParamValue,
     "TrackFX_GetFormattedParamValue"},
#endif
#if defined(REAPERAPI_WANT_TrackFX_GetFXGUID) || !defined(REAPERAPI_MINIMAL)
